...
// The profile grid contents and how they are read (GLO-261). The scope
// vocabulary the tab strip marks with lives next door in `ProfileScope.swift`;
// both were one file until it crossed SwiftLint's 300-line ceiling.
