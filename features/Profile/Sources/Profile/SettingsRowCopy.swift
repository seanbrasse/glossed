...
// What each settings row can honestly say beside its label. Split out of
// `SettingsModel.swift` when the linked-socials row (GLO-261) took that file
// past SwiftLint's 300-line ceiling — a move, nothing renamed.
