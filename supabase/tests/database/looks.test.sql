...
-- 1-4 · the adult owner: full CRUD on own rows
...
select lives_ok(
    $$insert into look_tags (look_id, variant_id, x, y)
      values ('18000000-0000-0000-0000-000000000001', 'e8000000-0000-0000-0000-000000000001', 0.5, 0.5)$$,
...
-- 5-7 · another user: a draft is invisible and untouchable
...
-- 8-9 · the minor gate, asserted directly on both tables (delta 11)
...
-- 10-12 · public read is scope-gated: state alone is not enough
...
-- 13 · a block severs regardless of scope
set local role postgres;
...
-- 14 · fail-closed: an unknown-to-the-policy state renders to nobody else
set local role postgres;
delete from blocks;
